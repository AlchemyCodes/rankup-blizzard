...
public class MysticInventory {

    public void open(Player player) {

        ChestGui inventory = new ChestGui(3, "§8Caixa Mística | Recompensas");
        StaticPane pane = new StaticPane(0, 0, 9, 5);

        item(pane, "crates.mystic", PluginImpl.getInstance().Crates.getConfig());
