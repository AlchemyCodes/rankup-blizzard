package blizzard.development.farm.builders.item;

import blizzard.development.farm.utils.apis.Skull;
import blizzard.development.farm.utils.text.TextUtils;
...
public class ItemBuilder {
    ...
    public ItemBuilder setDisplayName(String name) {
        itemMeta.displayName(TextUtils.parse(name.replace("&", "§")));
        return this;
    }

    public ItemBuilder setLore(List<String> lore) {
        List<Component> component = lore.stream()
            .map(line -> TextUtils.parse(line.replace("&", "§")))
