...
public class NumberFormat {
    private static blizzard.development.currencies.utils.NumberFormat instance;
    ...
    public static blizzard.development.currencies.utils.NumberFormat getInstance() {
        if (instance == null) instance = new blizzard.development.currencies.utils.NumberFormat();
        return instance;
    }
}
