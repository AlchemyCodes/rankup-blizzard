package blizzard.development.currencies.commands.currencies.mine.subcommands;
...
public class BlocksExchangeCommand extends BaseCommand {
    ...
    public void onPayCommand(CommandSender sender, String nickname, String amount) {
        ...
        if (!impl.Config.getBoolean("currencies.can-pay.blocks")) {
        ...
        if (player.equals(target)) {
            sender.sendActionBar(TextAPI.parse("§c§lEI! §cVocê não pode enviar blocos para si mesmo."));
            return;
        }
        ...
        try {
            ...
            if (bal < doubleAmount) {
                sender.sendActionBar(TextAPI.parse("§c§lEI! §cVocê não possui a quantia necessária de blocos para realizar essa transação."));
                return;
            }
            if (doubleAmount <= 0) {
            ...
            if (api.transferBalance(player, target, currency, doubleAmount)) {
                List<String> playerMessages = Arrays.asList(
                        ...
                        "§bVocê pagou ❒" + "§l" + format.formatNumber(doubleAmount) + "§b blocos para o jogador " + target.getName() + ".",
                        ""
                );
                ...
                List<String> targetMessages = Arrays.asList(
                        ...
                        "§bVocê recebeu ❒" + "§l" + format.formatNumber(doubleAmount) + "§b blocos do jogador " + player.getName() + ".",
                        ""
                );
            ...
            if (api.transferBalance(player, target, currency, doubleFormatted)) {
                List<String> playerMessages = Arrays.asList(
                        "",
                        "§b§lTransferência realizada!",
                        "§bVocê pagou ❒" + "§l" + format.formatNumber(doubleFormatted) + "§b blocos para o jogador " + target.getName() + ".",
                        ""
                );
                ...
                List<String> targetMessages = Arrays.asList(
                        "",
                        "§b§lTransferência recebida!",
                        "§bVocê recebeu ❒" + "§l" + format.formatNumber(doubleFormatted) + "§b blocos do jogador " + player.getName() + ".",
                        ""
                );
    ...
    public void onSetCommand(CommandSender sender, String nickname, String amount) {
        ...
        try {
            ...
            if (api.setBalance(target, currency, doubleAmount)) {
                sender.sendActionBar(TextAPI.parse("§a§lYAY! §aVocê setou " + format.formatNumber(doubleAmount) + " blocos para o jogador " + target.getName()));
            } else {
                sender.sendActionBar(TextAPI.parse("§c§lEI! §cOcorreu um erro ao concluir a transação."));
            }
        } catch (NumberFormatException ex) {
            ...
            if (api.setBalance(target, currency, doubleFormatted)) {
                sender.sendActionBar(TextAPI.parse("§a§lYAY! §aVocê setou " + format.formatNumber(doubleFormatted) + " blocos para o jogador " + target.getName()));
            } else {
                sender.sendActionBar(TextAPI.parse("§c§lEI! §cOcorreu um erro ao concluir a transação."));
            }
        }
    ...
    public void onAddCommand(CommandSender sender, String nickname, String amount) {
        ...
        try {
            ...
            if (api.addBalance(target, currency, doubleAmount)) {
                sender.sendActionBar(TextAPI.parse("§a§lYAY! §aVocê adicionou " + format.formatNumber(doubleAmount) + " blocos para o jogador " + target.getName()));
            } else {
                sender.sendActionBar(TextAPI.parse("§c§lEI! §cOcorreu um erro ao concluir a transação."));
            }
        } catch (NumberFormatException ex) {
            ...
            if (api.addBalance(target, currency, doubleFormatted)) {
                sender.sendActionBar(TextAPI.parse("§a§lYAY! §aVocê adicionou " + format.formatNumber(doubleFormatted) + " blocos para o jogador " + target.getName()));
            } else {
                sender.sendActionBar(TextAPI.parse("§c§lEI! §cOcorreu um erro ao concluir a transação."));
            }
        }
    ...
    public void onRemoveCommand(CommandSender sender, String nickname, String amount) {
        ...
        try {
            ...
            if (api.removeBalance(target, currency, doubleAmount)) {
                sender.sendActionBar(TextAPI.parse("§a§lYAY! §aVocê removeu " + format.formatNumber(doubleAmount) + " blocos do jogador " + target.getName()));
            } else {
                sender.sendActionBar(TextAPI.parse("§c§lEI! §cOcorreu um erro ao concluir a transação."));
            }
        } catch (NumberFormatException ex) {
            ...
            if (api.removeBalance(target, currency, doubleFormatted)) {
                sender.sendActionBar(TextAPI.parse("§a§lYAY! §aVocê removeu " + format.formatNumber(doubleFormatted) + " blocos do jogador " + target.getName()));
            } else {
                sender.sendActionBar(TextAPI.parse("§c§lEI! §cOcorreu um erro ao concluir a transação."));
            }
        }
