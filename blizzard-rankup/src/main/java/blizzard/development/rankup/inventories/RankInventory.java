...
public class RankInventory {
    ...
    public static void openRankInventory(Player player) {
        ...
        GuiItem ranks = new GuiItem(ranks(), event -> {event.setCancelled(true);
            RanksInventory.openRanksInventory(player);});

        GuiItem tops = new GuiItem(tops(), event -> { event.setCancelled(true);
            TopsInventory.openTopInventory(player);});

        GuiItem rankup = new GuiItem(rankup(), event -> { event.setCancelled(true);
